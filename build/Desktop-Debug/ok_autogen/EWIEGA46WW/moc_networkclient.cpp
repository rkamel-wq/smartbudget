...
void NetworkClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NetworkClient::*)(const QString & )>(_a, &NetworkClient::statusChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkClient::*)(const QString & )>(_a, &NetworkClient::errorOccurred, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkClient::*)()>(_a, &NetworkClient::messageSent, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkClient::*)(const QString & )>(_a, &NetworkClient::messageReceived, 3))
            return;
    }
}
...
void *NetworkClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "INetworkClient"))
        return static_cast< INetworkClient*>(this);
...
// SIGNAL 0
void NetworkClient::statusChanged(const QString & _t1)
{
...
// SIGNAL 2
void NetworkClient::messageSent()
{
